...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "ACE_COMBAT_3_ELECTROSPHERE_RECOMP_PROJECT_ROOT",
    .build_dir_env = "ACE_COMBAT_3_ELECTROSPHERE_RECOMP_BUILD_DIR",
    .force_setup_env = "ACE_COMBAT_3_ELECTROSPHERE_RECOMP_FORCE_SETUP",
