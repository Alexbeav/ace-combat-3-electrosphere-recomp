...
The supported serial set is $(@{ordinal=21; slug=ace-combat-3-electrosphere; title=Ace Combat 3: Electrosphere (Japan); serials=System.Object[]; expected_disc_count=2; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses
